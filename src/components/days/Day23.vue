    ...
    <div slot="page-content">
      ...
      <p class = textbox>
       Ahoi, landlubbers! To participate in the todays <font size= "6"><b>Giveaway</b></font> simply do the following tasks:
        <ul>
        <li><div class=link>Join our Talkaboat Advent Calendar &nbsp; <a href="https://app.involve.me/talkaboat-advent-calendar-quiz" target="_blank">  <b>Quiz</b> </a> </div></li>
        <li>Become the Quizmaster!</li>
       </ul>
